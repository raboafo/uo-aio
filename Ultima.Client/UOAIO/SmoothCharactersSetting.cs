...
public class SmoothCharactersSetting : IVisualizableSetting
{
	...
	public string LabelKey => this.Enabled ? "smooth" : "rough";
	...
	public void Draw(int x, int y)
	{
		...
		int TextureX = 0;
		int TextureY = 0;
		Frame frame = Engine.m_Animations.GetFrame(null, 400, 4, 1, 0, xCenter, yCenter, Hues.Load(1004), ref TextureX, ref TextureY, preserveHue: false);
