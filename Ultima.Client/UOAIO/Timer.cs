...
public class Timer
{
	...
	public bool Enabled => this.m_State;
	...
	public object GetTag(string name)
	{
		...
		if (this.tags != null)
		{
			this.tags.TryGetValue(name, out value);
		}
		return value;
	}
	...
	{
		return $"Delay: {this.m_Delay}ms MaxExecute: {this.m_MaxExecute} Running: {this.m_State} Target: {this.m_OnTick.Method.Name}";
	}
}
