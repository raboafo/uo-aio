...
public class GCategoryPanel : GAlphaBackground
{
	...
	protected internal override void Draw(int X, int Y)
	{
		...
		{
			Renderer.SolidRect(GumpColors.ControlDark, X + 1, Y + 21, this.Width - 2, this.Height - 22, base.m_Clipper);
		}
	}
		...
		: base(0, 0, 279, 22)
	{
		...
		{
			ObjectEditorEntry objectEditorEntry = entries[i] as ObjectEditorEntry;
			this.m_Entries[i] = new GPropertyEntry(objectEditorEntry.Object, objectEditorEntry);
