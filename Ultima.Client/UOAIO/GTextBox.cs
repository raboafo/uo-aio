...
public class GTextBox : Gump
{
	...
	public int MaxChars
	{
		...
		set
		{
			...
			this.UpdateLabel(forceUpdate: true, this.m_HNormal);
		}
	}
	...
	public virtual bool ShowCaret => true;
	...
	public GTextBox(int GumpID, bool HasBorder, int X, int Y, int Width, int Height, string StartText, IFont f, IHue HNormal, IHue HOver, IHue HFocus)
		: this(GumpID, HasBorder, X, Y, Width, Height, StartText, f, HNormal, HOver, HFocus, '\0')
	{
	}
		...
		: base(X, Y)
	{
		...
		this.UpdateLabel(forceUpdate: false, this.m_HNormal);
	}

	internal virtual void Focus()
	{
		this.m_Focus = true;
		this.UpdateLabel(forceUpdate: false, this.m_HFocus);
	...
	protected internal override void OnMouseEnter(int X, int Y, MouseButtons mb)
	{
		if (!this.m_Focus)
		{
			this.UpdateLabel(forceUpdate: false, this.m_HOver);
		}
	}
