...
public sealed class MobileAttributes
{
	private sealed class LocalAttributes
	{
		...
		{
			public static AosAttributes Default;
			...
			static AosAttributes()
			{
				AosAttributes.Default = new AosAttributes();
			}
		}

		public static LocalAttributes Default;

		private AosAttributes aosAttributes;
		...
		private AosAttributes QueryAosAttributes()
		{
			return this.aosAttributes ?? AosAttributes.Default;
		}

		private AosAttributes EnsureAosAttributes()
		{
			if (this.aosAttributes == null)
			{
				this.aosAttributes = new AosAttributes();
			}
			return this.aosAttributes;
		}

		static LocalAttributes()
		{
			LocalAttributes.Default = new LocalAttributes();
		}
	}

	public static MobileAttributes Default;
	...
	private LocalAttributes QueryLocalAttributes()
	{
		return this.localAttributes ?? LocalAttributes.Default;
	}

	private LocalAttributes EnsureLocalAttributes()
	{
		if (this.localAttributes == null)
		{
			this.localAttributes = new LocalAttributes();
		}
		return this.localAttributes;
	}

	static MobileAttributes()
	{
		MobileAttributes.Default = new MobileAttributes();
	}
}
