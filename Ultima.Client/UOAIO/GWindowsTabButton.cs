...
public class GWindowsTabButton : Gump, IClickable
{
	protected WindowsTabButtonStyle m_Style;
	...
	public WindowsTabButtonStyle Style
	{
		get
		{
			return this.m_Style;
	...
	protected internal override void Draw(int x, int y)
	{
		...
		switch (this.m_Style)
		{
		case WindowsTabButtonStyle.Normal:
			switch (this.m_State)
			{
			case 0:
			...
			break;
		case WindowsTabButtonStyle.Flat:
			switch (this.m_State)
			{
			case 0:
	...
	public GWindowsTabButton(string text, int x, int y)
		: this(text, x, y, 80, 20, null)
	{
	}

	public GWindowsTabButton(string text, int x, int y, int width, int height, EventHandler eh)
		: base(x, y)
	{
		this.m_Width = width;
